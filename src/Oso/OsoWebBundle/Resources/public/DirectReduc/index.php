...
<HTML>
	...
	<HEAD>
		...
		<!-- afin qu'il y ait pas de décalage dans le navigateur Internet explorer, on lui rajoute un correctif css -->
		<!--[if IE]>
	...
	<BODY>
		...
		<DIV id="header">
			...
			<?php include 'structure_page/header.php' ?> <!-- en-tête de la page -->
