<?php
	...
	{
		$req4=  $req4." AND (`OFFRE_TITRE` LIKE '%".ucfirst($mot_cle)."%'  OR `OFFRE_TITRE` LIKE '%".strtoupper($mot_cle)."%'  OR `OFFRE_TITRE` LIKE '%".mb_strtolower($mot_cle)."%'  ) "; // on selectionne les annonces comportant le mot ou la phrase qu'il a tapé.
	}
